<div class="sources-container">
    <div class="data-source text-width">
        ...
        <p>Data is from the <strong>2022-23 school year</strong> (unless otherwise noted) and comes from the <a href="https://www.ode.state.or.us/data/ReportCard/Media" target="_blank">Oregon Department of Education</a>. Map data comes from the <a href="https://www.census.gov/cgi-bin/geo/shapefiles/index.php?year=2023&layergroup=School+Districts" target="_blank">US Census</a>.</p>
